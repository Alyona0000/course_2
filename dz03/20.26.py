#T20.26 В умовах попередньої задачі, зафіксувати якісь 5 карт на 1 руці,
#виконати фіксоване роздавання на інші руки та обчислити ймовірність того,
#що на будь-якій руці, окрім першої, опиняться:
...
d = Decks(num_decks=200000, min_rank=7)  # 3 колоди, карти від 7 до туза
print("Кількість колод:", len(d.all_decks))  # Виводимо кількість колод

hands = d.deal(num_players=1, num_cards=5)  # Роздаємо по 5 карт кожному гравцю з кожної колоди
...
print("всього рук", case_1_resold.size)
